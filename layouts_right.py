...
def create_right_buttons(main_window):
    ...
    """)
    button1.clicked.connect(main_window.get_ready)
    ...
    """)
    button2.clicked.connect(main_window.show_off)
    ...
    """)
    button6.clicked.connect(main_window.wiggle)
    ...
    """)
    button7.clicked.connect(main_window.kick_right)
    ...
    """)
    button8.clicked.connect(main_window.kick_left)
